...
all_e = c(current_e);
for(i in 1:16){
	current_e = current_e + 0.003
	all_e = c(all_e, current_e);
}

file.create("C:\\Users\\jaspe\\Documents\\School\\Jaar4 Semester1\\Bachelorproef_21-22\\output.csv");
...
write.csv(df, file="C:\\Users\\jaspe\\Documents\\School\\Jaar4 Semester1\\Bachelorproef_21-22\\output.csv");